            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-sm text-balance text-muted-foreground">
                  Ingrese su correo electrónico a continuación para crear tu
                  cuenta.
                </p>
              </div>
              <Field>
                <FieldLabel htmlFor="username">Nombre</FieldLabel>
                <Input
                  id="username"
                  type="text"
                  name="username"
              ...
              <Field>
                ...
                <FieldDescription>
                  Debe tener al menos 6 caracteres. Debe contener al menos una
